                    ...
                    <div className="col2">
                        ...
                        <a href="#" className="col1-row1 unit-9 no-height" data-aos="fade-up" data-aos-delay="100" style={{marginTop: '8%'}}>
                            ...
                            <div className="unit-9-content">
                                ...
                                <span>Giovedì 8:00 &mdash; 9:30</span>
                            </div>
                        </a>
                        ...
                        <a href="#" className="col1-row1 unit-9 no-height" data-aos="fade-up" data-aos-delay="100" style={{marginTop: '8%'}}>
                            ...
                            <div className="unit-9-content">
                                <h2>Alman</h2>
                                <span>Giovedì 12:00 &mdash; 12:30</span>
                            </div>
                        </a>
                        ...
                        <a href="#" className="col1-row1 unit-9 no-height" data-aos="fade-up" data-aos-delay="100" style={{marginTop: '8%'}}>
                            ...
                            <div className="unit-9-content">
                                ...
                                <span>Giovedì 12:30 &mdash; 14:00</span>
                            </div>
                        </a>
                        ...
                        <a href="#" className="col1-row1 unit-9 no-height" data-aos="fade-up" data-aos-delay="100" style={{marginTop: '8%'}}>
                            ...
                            <div className="unit-9-content">
                                <h2>Two Five </h2>
                                <span>Giovedì 14:30 &mdash; 15:00</span>
                            </div>
                        </a>
                        ...
                        <a href="#" className="col1-row1 unit-9 no-height" data-aos="fade-up" data-aos-delay="100" style={{marginTop: '8%'}}>
                            ...
                            <div className="unit-9-content">
                                <h2>Zona Rock</h2>
                                <span>Giovedì 15:00 &mdash; 16:00</span>
                            </div>
                        </a>
